<template>
  <div
    class="sticky flex flex-col top-0 left-0 w-64 bg-white h-screen border-r"
  >
    <div class="overflow-y-auto overflow-x-hidden flex-grow">
      <ul class="flex flex-col py-4 space-y-1">
        ...
        <li>
          <span
            class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:cursor-pointer hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"
            @click="handleLogout"
          >
            <span class="inline-flex justify-center items-center ml-4">
              <svg
